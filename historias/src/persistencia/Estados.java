...
@NamedQueries({
    ...
    @NamedQuery(name = "Estados.findByImagen", query = "SELECT e FROM Estados e WHERE e.imagen = :imagen")})
public class Estados implements Serializable {
    ...
    public String toString() {
        return "persistencia.Estados[codigo=" + codigo + "]";
    }
