...
insert  into `cabeceracompra`(`codigo`,`sucursal`,`factura`,`proveedores`,`fecha`,`cantidad`,`pu`,`subtotal`,`iva`,`total`,`series`,`documento`) values (1,NULL,1,1,'2011-07-25',9,NULL,NULL,NULL,145.00,'','COM'),(11,NULL,NULL,NULL,'2011-07-23',0,NULL,NULL,NULL,0.00,NULL,'VEN'),(15,NULL,NULL,NULL,'2011-07-23',0,NULL,NULL,NULL,0.00,NULL,'VEN'),(16,NULL,NULL,NULL,'2011-07-23',0,NULL,NULL,NULL,0.00,NULL,'PRE');
...
insert  into `cxcobrar`(`codigo`,`factura`,`debe`,`haber`,`total`,`fecha`,`tipo`,`descuento`,`efectivo`,`cheque`,`debito`,`tarjeta`,`nocheque`,`notarjeta`,`nocuenta`) values (1,1,'16.80','0.00','16.80','2011-07-01',NULL,'0.00','0.00','0.00','0.00',NULL,'','',NULL),(2,2,'16.80','0.00','16.80','2011-07-01',NULL,'0.00','0.00','0.00','0.00',NULL,'','',NULL);
...
insert  into `detalle`(`codigo`,`factura`,`plan`,`equipos`,`mes`,`cantidad`,`precio`,`descuento`,`beca`,`total`,`descripcion`,`anio`,`asignado`) values (1,1,1,NULL,7,1,NULL,NULL,NULL,'15.00','generada',2011,NULL),(2,2,1,NULL,7,1,NULL,NULL,NULL,'15.00','generada',2011,NULL);
...
insert  into `detallecompra`(`codigo`,`compra`,`contrato`,`equipos`,`cantidad`,`costo`,`pvp1`,`pvp2`,`pvp3`,`pvp4`,`asignado`,`estado`) values (1,1,NULL,3,3,99.00,NULL,NULL,NULL,NULL,NULL,NULL),(2,1,NULL,1,3,23.00,NULL,NULL,NULL,NULL,NULL,NULL),(3,1,NULL,2,3,23.00,NULL,NULL,NULL,NULL,NULL,NULL),(13,11,7,1,-1,20.22,NULL,NULL,NULL,NULL,NULL,NULL),(17,15,7,3,-1,18.00,NULL,NULL,NULL,NULL,NULL,NULL),(18,16,7,3,-1,18.00,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `factura`(`codigo`,`sucursal`,`numero`,`contratos`,`sector`,`fecha`,`clientes`,`subtotal`,`descuento`,`baseiva`,`porcentajeiva`,`valoriva`,`total`,`estado`,`observacion`) values (1,1,NULL,7,NULL,'2011-07-01',2,'15.00','0.00','15.00','12.00','1.80','16.80',1,NULL),(2,1,NULL,8,NULL,'2011-07-01',10,'15.00','0.00','15.00','12.00','1.80','16.80',1,NULL);
...
insert  into `procesos`(`fechastring`,`fecha`,`ejecutado`,`fechaejecutado`,`problemas`,`empleado`) values ('120117','2011-07-01',1,'2011-07-01 00:11:34','Re-ejecutado',NULL),('220117','2011-07-01',1,'2011-07-01 00:11:34','Re-ejecutado',NULL),('320117','2011-07-01',1,'2011-07-01 00:11:34','Re-ejecutado',NULL);
...
insert  into `series`(`codigo`,`serie`,`detallecompra`,`contratos`,`estado`) values (1,'1',1,NULL,'C'),(2,'2',1,NULL,'C'),(3,'3',1,NULL,'C'),(4,'4',2,NULL,'C'),(5,'5',2,NULL,'C'),(6,'6',2,NULL,'C'),(7,'7',3,NULL,'C'),(8,'8',3,NULL,'C'),(9,'9',3,NULL,'C'),(20,'4',13,7,'V'),(25,'2',17,7,'V'),(26,'2',18,7,'P');
