    ...
    public String soporteTecnico(String cedula,Soporte sop) {
        ...
        if (emp != null) {
            ...
            mensaje = "<!DOCTYPE HTML PUBLIC "
                    ...
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='11'><p><strong>INFORMACION DEL CLIENTE </strong></p></td>"
                    + "     <td colspan='2'><p><strong>HORA DE LLEGADA DE TÉCNICO:"+(sop.getHora()!=null?sop.getHora().toLocaleString().substring(10):"_")+"</strong></p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    ...
                    + "     <td colspan='3'>"+sop.getContrato().getRadios().getNodos().getNombre()+ " "+sop.getContrato().getRadios().getNombre() +"</td>"
                    + "   </tr>"
                    + "   <tr>"
                    ...
                    + "     <td colspan='7' class='style1'><p>Ing. Yessica Ramos,Ext 0 - 0999-187-897 </p></td>"
                    ...
                    + "     <td colspan='7' class='style1'><p>Ing. Juan Carlos Gualotu&ntilde;a, Ext 110 - 0999-188-049 </p></td>"
                    ...
                    + "     <td colspan='7' class='style1'><p>Dra. Emilia V&eacute;lez Castro, Tel&eacute;f.. 0999195089 </p></td>"
                    + "     <td colspan='3' class='style1'><p><a href='mailto:emiillescas@yahoo.com'>emiillescas@yahoo.com </a></p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='13' class='style1'><p>ATENDIDO POR: </p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='13' class='style1'><p>"+sop.getEmpleados().getApellidos()+" "+sop.getEmpleados().getNombres()+"</p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='13' class='style1'><p>Creado: </p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='13' class='style1'><p>"+sop.getFecha().toLocaleString()+"</p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='13' class='style1'><p>Modificado: </p></td>"
                    + "   </tr>"
                    + "   <tr>"
                    + "     <td colspan='13' class='style1'><p>"+(sop.getFechamodifica()!=null?sop.getFechamodifica().toLocaleString():"")+"</p></td>"
                    + "   </tr>"
                    + " </table>"
                    + " </body> "
                    + " </html> ";
