...
public class autoCompletarClientesSector extends Combobox {
...
//
//    }
    public autoCompletarClientesSector(String value) {
        ...
        if (!evt.isChangingBySelectBack()) {
            ...
            for (Iterator<Clientes> itEst = estu.iterator(); itEst.hasNext();) {
                ...
                if(estudiantes.getRazonsocial() != null && !estudiantes.getRazonsocial().isEmpty()){
                    c.setLabel(estudiantes.getRazonsocial() + " | ["+estudiantes.getApellidos() + " " + estudiantes.getNombres()+"]");
                }
