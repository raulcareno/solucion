...
public class autoCompletarMateriales extends Combobox {
...
//		Arrays.sort(arreglo);
    ...
    public autoCompletarMateriales() {
        //	refresh("");
...
//		Arrays.sort(arreglo);
    ...
    public autoCompletarMateriales(String value) {
        ...
        if (!evt.isChangingBySelectBack()) {
            ...
            if (abuscar.length() > 0) {
                estu = adm.query("Select o from Equipos as o "
                        ...
                        + " and o.bien = true and o.material = true "
