...
//    }
  static   String informat = "ismaelsamijcinform@2020674589";
    ...
    public  void SendMail(String para,String archivo,String institucion){
        ...
        prop.put("mail.smtp.auth", "true");
         try{
            ...
            texto.setText("Se adjunta respaldo de base de datos ISP con fecha:  "+new Date().toLocaleString());
            ...
            msg.setSubject("RESPALDO BD DE: "+institucion+" ISP :"+new Date().toLocaleString());
            Transport.send(msg);     
        }catch (Exception e){
...
//        String password = ""+this.pass;
        return new PasswordAuthentication(username, informat.replace("jcinform", "").replace("674589", ""));
    }
