...
public String estudiante;
 ...
 public MateriaProfesor materiaProfesor;
    ...
    public void setPieTextoAprobado(String pieTextoAprobado) {
        this.pieTextoAprobado = pieTextoAprobado;
    }

    public String getPieTextoReprobado() {
        return pieTextoReprobado;
    }
    ...
    public String getAprovechamientoLetras() {
        return aprovechamientoLetras;
    }

    public void setAprovechamientoLetras(String aprovechamientoLetras) {
        this.aprovechamientoLetras = aprovechamientoLetras;
    }

    public String getDisciplinaLetras() {
        return disciplinaLetras;
    }
