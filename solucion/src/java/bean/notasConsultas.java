...
//     if(listad==null){
        ...
        List sistemas = adm.query("Select o from Sistemacalificacion as o "
                + "where o.periodo.codigoper = '" + periodo.getCodigoper() + "'  and o.seimprime = true   order by o.orden  ");
            ...
            for (int j = 0; j < vec.size(); j++) {
                ...
                if (j >= 2) {
                    ...
                    if (valor.equals(0.0)) {
                        ...
                        if (cuantitativa == false || ((Sistemacalificacion) sistemas.get(sis)).getEsequivalencia()) {
