...
public class NotaActaGeneral {
    ...
    public NotaActaGeneral(){}
    private String nombres;
    private String curso,estado;
    ...
    public Double getInspector() {
        return inspector;
    }

    public void setInspector(Double inspector) {
    ...
    public void setProfesores(Double profesores) {
