...
public String rFecha (Date fecha){
    ...
    void llenar(Matriculas matricula) {
        try {
            ...
            } catch (Exception asdx) {Logger.getLogger(matriculasBean1.class.getName()).log(Level.SEVERE, null, asdx);}
