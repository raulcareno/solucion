...
public class ReporteActaDataSource implements JRDataSource {
    ...
    public Object getFieldValue(JRField campo) throws JRException {
        ...
        try {
            ...
            } else if ("listaNotas3".equals(fieldName)) {
                ArrayList<Estudiantes> matriculas = new ArrayList<Estudiantes>();
                matriculas.add(nodo.getEstudiante());
                valor = new JRBeanCollectionDataSource(matriculas);

            } else if ("listaNotas4".equals(fieldName)) {
                ArrayList<Estudiantes> matriculas = new ArrayList<Estudiantes>();
                matriculas.add(nodo.getEstudiante());
                valor = new JRBeanCollectionDataSource(matriculas);

            } else if ("listaNotas5".equals(fieldName)) {
                ArrayList<Estudiantes> matriculas = new ArrayList<Estudiantes>();
                matriculas.add(nodo.getEstudiante());
                valor = new JRBeanCollectionDataSource(matriculas);
            ...
            } else if ("codigoclave".equals(fieldName)) {
                valor = nodo.getEstudiante().getCodigo();
