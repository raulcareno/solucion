 ...
 * @author GEOVANNY
 */
public class CxcobrarSource implements JRDataSource {
    ...
    public CxcobrarSource(List lista) {
        super();
    ...
    public Object getFieldValue(JRField campo) throws JRException {
        ...
        try {
            ...
            if ("factura".equals(fieldName)) {
                ...
                valor = nodo.getFactura().getCodigo();
                ...
                try {
                    valor = meses(nodo.getFactura().getFecha().getMonth())+ (nodo.getFactura().getFecha().getYear()+1900);
                } catch (Exception e) {
                    System.out.println("ERROR EN FECHA" + e);
                }
                ...
                try{
                    valor = nodo.getFactura().getTarjetas().getTarjeta();
                }catch(Exception e){
                }
            } else if ("clientenombre".equals(fieldName)) {
                try {
                        valor = nodo.getFactura().getTarjetas().getClientes().getNombres();    
                } catch (Exception e) {
                }
                ...
                valor = nodo.getFactura().getObservacion();
            }
        } catch (Exception e) {
            Logger.getLogger(CxcobrarSource.class.getName()).log(Level.SEVERE, null, e);
        }
        return valor;
    }
