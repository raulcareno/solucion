  ...
  public Formulario() {
    ...
    btnAlta.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        ...
        try {
          Connection conexion=DriverManager.getConnection("jdbc:mysql://localhost/academico","root" ,"jcinform@2020");
    ...
    btnConsultaPorCdigo.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        ...
        try {
          Connection conexion=DriverManager.getConnection("jdbc:mysql://localhost/academico","root" ,"jcinform@2020");
          Statement comando=conexion.createStatement();
          ResultSet registro = comando.executeQuery("DESCRIBE accesos;");
          if (registro.next()==true) {
//              System.out.println("fetch:   "+ registro.getC);
            tf1.setText(registro.getString(1)+"");
            tf2.setText(registro.getString(2)+"");
          } else {
