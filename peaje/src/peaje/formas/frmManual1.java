 ...
 * @author geovanny
 */
public class frmManual1 extends javax.swing.JInternalFrame {
 ...
 String separador = File.separatorChar + "";
    ...
    public frmManual1(Container contendor, Administrador adm1) {
...
//    }
    ...
    public void llenarCombo() {
        ...
        try {
            ...
            Logger.getLogger(frmManual1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"CLIENTES.swf"), BorderLayout.CENTER);
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"TARIFAS.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                        frame.setLocationByPlatform(true);
                         frame.setExtendedState(frame.MAXIMIZED_BOTH);
                          Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"AUDITORIA.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                         frame.setExtendedState(frame.MAXIMIZED_BOTH);
                          Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
                        frame.setIconImage(im);
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"RECONFIGURAR.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                         frame.setExtendedState(frame.MAXIMIZED_BOTH);
                          Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
                        frame.setIconImage(im);
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"TICKET_COBRAR.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                        frame.setLocationByPlatform(true);
                         Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
                        frame.setIconImage(im);
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"OPERADORES.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                        frame.setLocationByPlatform(true);
                         frame.setExtendedState(frame.MAXIMIZED_BOTH);
                          Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"REPORTES.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                        frame.setLocationByPlatform(true);
                         frame.setExtendedState(frame.MAXIMIZED_BOTH);
                          Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                        frame.getContentPane().add(new SimpleFlashExample(ubicacionDirectorio+"EMPRESA.swf"), BorderLayout.CENTER);
                        frame.setSize(800, 600);
                        frame.setLocationByPlatform(true);
                         frame.setExtendedState(frame.MAXIMIZED_BOTH);
                          Image im = new ImageIcon(getClass().getResource("/images/help.gif")).getImage();
