...
// <editor-fold defaultstate="collapsed" desc="FUNCIONES ACCIONES">
    ...
    public void limpiar() {
        ...
        System.gc();
        System.out.println("MB_Tck: " + (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024 / 1024);
    ...
    private void initComponents() {
        ...
        noTicket.setBounds(90, 10, 170, 20);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(90, 80, 130, 20);
        ...
        btnAgregar.setBounds(180, 150, 60, 50);
