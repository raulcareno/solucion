...
@ManagedBean
@SessionScoped
public class NotasBeanProfesores implements Serializable {
...
//        super();
        ...
        if (!permisos.verificarPermisoReporte("Registro de Notas", "ingresar_notas.jspx", "ingresar", true, "NOTAS")) {
            try {
                ...
                java.util.logging.Logger.getLogger(NotasBeanProfesores.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
...
//                            "and matCodigo.matCodigo = '" + notaIngresada.getMatCodigo().getMatCodigo() + "' ";
                    ...
                    Logger.getLogger(NotasBeanProfesores.class.getName()).log(Level.SEVERE, null, ex);
                    return;
                }
...
//        }
    ...
    public String eliminar(Notas obj) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotasBeanProfesores.class.getName()).log(Level.SEVERE, null, e);
    ...
    public List<SelectItem> getSelectedItemMaterias() {
        try {
            ...
            if (materiasListado.size() > 0) {
                ...
                for (Materias obj : materiasListado) {
                    items.add(new SelectItem(obj, obj.getNombre()));
                }
            } else {
