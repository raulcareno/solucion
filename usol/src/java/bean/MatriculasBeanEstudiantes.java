...
@ViewScoped
//@RequestScoped
public class MatriculasBeanEstudiantes {
    ...
    ;
    public MatriculasBeanEstudiantes() {
        if (adm == null) {
...
//        paisSeleccionado4 = estudiante.getPaiIdPais();
    ...
    public StreamedContent getImageAsStream() {
        try {
            ...
            Logger.getLogger(MatriculasBeanEstudiantes.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
...
//                inicializar();
                ...
                java.util.logging.Logger.getLogger(MatriculasBeanEstudiantes.class.getName()).log(Level.SEVERE, null, e);
                FacesContext.getCurrentInstance().addMessage(findComponent(context.getViewRoot(), "form").getClientId(), new FacesMessage(FacesMessage.SEVERITY_ERROR, e.getMessage(), e.getMessage()));
            }
    ...
    public void handleFileUpload(FileUploadEvent event) {
        try {
            ...
            try {
                ...
                Logger.getLogger(MatriculasBeanEstudiantes.class.getName()).log(Level.SEVERE, null, ax);
