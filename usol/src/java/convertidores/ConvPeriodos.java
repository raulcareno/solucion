...
@FacesConverter(value = "ConvPeriodos", forClass = Periodos.class)
public class ConvPeriodos  implements Converter {
...
//    }
    ...
    @Override
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if(value instanceof Periodos){
           if (value == null) {
            return null;
        }
        if(((Periodos)value).getIdPeriodos() ==null){
            return null;
        }
        
            return Integer.toString(((Periodos)value).getIdPeriodos());  
        }else{
            return null;
        }
