...
@FacesConverter(value = "ConvModalidad", forClass = Modalidad.class)
public class ConvModalidad  implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
           Modalidad cat = new Modalidad(Integer.parseInt(value));
            return cat;
        } catch (Exception e) {
...
//    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if(((Modalidad)value).getIdModalidad() ==null){
            return null;
        }
        
            return Integer.toString(((Modalidad)value).getIdModalidad());  
        }else{
            return null;
        }
