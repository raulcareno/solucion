...
@FacesConverter(value = "ConvHorarios", forClass = Horarios.class)
public class ConvHorarios  implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
           Horarios cat = new Horarios(Integer.parseInt(value));
            return cat;
        } catch (Exception e) {
...
//    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if(((Horarios)value).getIdHorarios() ==null){
            return null;
        }
        
            return Integer.toString(((Horarios)value).getIdHorarios());  
        }else{
            return null;
        }
