...
@FacesConverter(value = "ConvPerfiles", forClass = Perfiles.class)
public class ConvPerfiles  implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
           Perfiles cat = new Perfiles(Integer.parseInt(value));
            return cat;
        } catch (Exception e) {
...
//    }
    ...
    @Override
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if(value instanceof Perfiles){
           if (value == null) {
            return null;
        }
        if(((Perfiles)value).getIdPerfiles() ==null){
            return null;
        }
        
            return Integer.toString(((Perfiles)value).getIdPerfiles());  
        }else{
            return null;
        }
