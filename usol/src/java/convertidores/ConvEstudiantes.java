...
@FacesConverter(value = "ConvEstudiantes", forClass = Estudiantes.class)
public class ConvEstudiantes  implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
           Estudiantes cat = new Estudiantes(value);
            return cat;
        } catch (Exception e) {
...
//    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if(((Estudiantes)value).getIdEstudiantes() ==null){
            return null;
        }
        
            return  (((Estudiantes)value).getIdEstudiantes());  
        }else{
            return null;
        }
