...
@FacesConverter(value = "ConvEscuela", forClass = Escuela.class)
public class ConvEscuela  implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
           Escuela cat = new Escuela(Integer.parseInt(value));
            return cat;
        } catch (Exception e) {
...
//    }
    ...
    @Override
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if(value instanceof Escuela){
           if (value == null) {
            return null;
        }
        if(((Escuela)value).getIdEscuela() ==null){
            return null;
        }
        
            return Integer.toString(((Escuela)value).getIdEscuela());  
        }else{
            return null;
        }
