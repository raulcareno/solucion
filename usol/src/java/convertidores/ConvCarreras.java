...
@FacesConverter(value = "ConvCarreras", forClass = Carreras.class)
public class ConvCarreras  implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
           Carreras cat = new Carreras(Integer.parseInt(value));
            return cat;
        } catch (Exception e) {
...
//    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if(((Carreras)value).getIdCarreras() ==null){
            return null;
        }
        
            return Integer.toString(((Carreras)value).getIdCarreras());  
        }else{
            return null;
        }
